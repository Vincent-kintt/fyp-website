...
export default function TaskEditForm({ reminder, isActive, onSave, onCancel, variant = "modal", className = "" }) {
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className={`flex-1 overflow-y-auto p-4 space-y-6 ${className}`} style={{ scrollbarWidth: "thin", scrollbarColor: "rgba(155, 155, 155, 0.5) transparent", fontSize: "14px", overscrollBehavior: "contain" }}>
        {error && (
