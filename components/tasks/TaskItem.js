    ...
    return (
      <>
        <div
          ...
          className={`group relative flex items-start gap-2 py-3 sm:py-2 px-4 rounded-xl bg-[var(--card-bg)] border border-[var(--card-border)] transition-opacity duration-150 ${
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            >
              ...
              <span>
                {showDate
                  ? formatTaskDate(currentTask.dateTime)
                  : formatTimeOnly(currentTask.dateTime)}
              </span>
              ...
              {currentTask.priority && currentTask.priority !== "medium" && (
                ...
                >
                  <span
                    className={`w-1.5 h-1.5 rounded-full ${getPriorityConfig(currentTask.priority).dotColor}`}
                  />
