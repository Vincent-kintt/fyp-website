...
function naiveToUTC(naiveStr, timezone) {
...
function projectReminder(r, timezone) {
...
export function createTools(userId, userTimezone = null) {
  const project = (r) => projectReminder(r, userTimezone);
  const toUTC = (dt) => naiveToUTC(dt, userTimezone);
  const tools = {};
...
export { naiveToUTC, formatInTimezone };
