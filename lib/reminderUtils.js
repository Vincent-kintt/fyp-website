/**
 * Shared reminder utilities for API routes — formatReminder, normalizeSubtasks,
 * field validation. Response helpers (apiSuccess/apiError) now live in
 * lib/api/response.js; they are re-exported here for back-compat.
 */
