...
export async function createReminder(params, userId) {
  const { title, description, dateTime, category, recurring, recurringType, priority, subtasks } = params;
...
export async function updateReminder(params, userId) {
  const { reminderId, title, description, dateTime, category, priority, subtasks } = params;
