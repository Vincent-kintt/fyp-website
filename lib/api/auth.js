...
// handler-set Cache-Control headers are only honored when they already include
// `no-store` — anything else (notably AI SDK's default `no-cache`) is
// overwritten to `private, no-store`.
//
