 ...
 */
const TAG_COLORS = [
  { bg: "bg-blue-500/8 dark:bg-blue-400/15", text: "text-blue-700 dark:text-blue-300" },
  { bg: "bg-green-500/8 dark:bg-green-400/15", text: "text-green-700 dark:text-green-300" },
  { bg: "bg-purple-500/8 dark:bg-purple-400/15", text: "text-purple-700 dark:text-purple-300" },
  { bg: "bg-orange-500/8 dark:bg-orange-400/15", text: "text-orange-700 dark:text-orange-300" },
  { bg: "bg-pink-500/8 dark:bg-pink-400/15", text: "text-pink-700 dark:text-pink-300" },
  { bg: "bg-cyan-500/8 dark:bg-cyan-400/15", text: "text-cyan-700 dark:text-cyan-300" },
  { bg: "bg-yellow-500/8 dark:bg-yellow-400/15", text: "text-yellow-700 dark:text-yellow-300" },
  { bg: "bg-red-500/8 dark:bg-red-400/15", text: "text-red-700 dark:text-red-300" },
];
...
export const STATUS_CONFIG = {
  pending: {
    ...
    selectedBg: "bg-yellow-500/8 dark:bg-yellow-400/15 border-yellow-500/20",
  },
  in_progress: {
    label: "In Progress",
    labelZh: "進行中",
    ...
    selectedBg: "bg-blue-500/8 dark:bg-blue-400/15 border-blue-500/20",
  },
  completed: {
    label: "Completed",
    labelZh: "已完成",
    ...
    selectedBg: "bg-green-500/8 dark:bg-green-400/15 border-green-500/20",
  },
  snoozed: {
    label: "Snoozed",
    labelZh: "已延後",
    ...
    selectedBg: "bg-purple-500/8 dark:bg-purple-400/15 border-purple-500/20",
  },
};
...
export const PRIORITY_CONFIG = {
  high: {
    ...
    selectedBg: "bg-red-500/8 dark:bg-red-400/15 border-red-500/20",
  },
  medium: {
    label: "Medium",
    dotColor: "bg-yellow-500",
