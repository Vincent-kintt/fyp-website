...
/**
 * Get the raw connected MongoClient. Needed by libraries that talk to
 * MongoDB directly (e.g. `RateLimiterMongo`, which manages its own
 * collection but requires the client to do so).
 */
