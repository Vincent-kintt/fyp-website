...
export function formatNote(doc) {
  return {
    ...
    // Inbox documents (type === "inbox") store numeric 0 — they're never
    // ordered in the tree, so we coerce numeric values to null on the wire
    // to keep the type discipline.
    sortOrder: typeof doc.sortOrder === "string" ? doc.sortOrder : null,
