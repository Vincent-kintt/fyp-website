...
// activeId is part of the signature for API consistency.
// Cycle prevention (excluding descendants from drop targets) is the caller's responsibility
// via getDescendantIds — this function only computes the projected depth and parentId.
